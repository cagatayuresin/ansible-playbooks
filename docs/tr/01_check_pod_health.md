...
Komut çalıştırıldığında, öncelikle "Ping connectivity test" adımıyla bağlantı testi yapılır. Başarılı ise `kubectl get pods -A -o wide` çıktısı ekrana yazdırılır:
